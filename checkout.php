   ...
   if($cart_query && $detail_query){
      ...
      <div class='message-container'>
         ...
         <div class='customer-details'>
            ...
            <p> your size : <span>".$flat."</span> </p>
            <p> your address : <span>".$street.", ".$city.", ".$state.", ".$country." - ".$pin_code."</span> </p>
            <p> your payment mode : <span>".$method."</span> </p>
            <p>(*pay when product arrives for all payment methods*)</p>
         </div>
...
<section class="checkout-form">
   ...
   <div class="display-order">
      ...
      <div class="flex">
         ...
         <div class="inputBox">
            <span>size</span>
            <input type="text" placeholder="e.g. Nike Shoes 1-31, Blue Pants-Xl, Brown Sweater-M" name="flat" required>
         </div>
         <div class="inputBox">
         ...
         <div class="inputBox">
            <span>state</span>
            <input type="text" placeholder="e.g. Candisari" name="state" required>
         </div>
         <div class="inputBox">
            <span>country</span>
         ...
         <div class="inputBox">
            <span>code post</span>
            <input type="text" placeholder="e.g. 40578" name="pin_code" required>
         </div>
      </div>
